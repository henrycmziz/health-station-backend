...
public class VideoJave2Utils {
     ...
     * 水印视频名字拼接
     */
    static final String NEW_VIDEO_WATER_NAME_PRE_STR = "_water";

    /***
     * 压缩视频文件后缀
     */
    static final String NEW_VIDEO_ZIP_NAME_PRE_STR = "_ys";
    /**
     * 视频截图文件名拼接
     * eg:原视频 test.mp4
    ...
    public static String generateVideoImageWatermark(String urlYuan, String targetUrl, String waterIconPath) throws EncoderException {
        ...
        if (StringUtils.isBlank(targetUrl)) {
            targetUrl = urlYuan.substring(0, urlYuan.lastIndexOf(".")) + NEW_VIDEO_WATER_NAME_PRE_STR + urlYuan.substring(urlYuan.lastIndexOf("."));
        }
        ...
        stopWatch.stop();
        logger.info("生成视频图片水印 = {}, 水印视频 = {}, 耗时 = {}毫秒", urlYuan, targetUrl, stopWatch.getTime());
        return targetUrl;
    }
     ...
     * @throws EncoderException 编码器异常
     */
    public static String getVideoDuration(String urlYuan) throws EncoderException {
        return durationFormatToString(BigDecimal.valueOf(readVideoLength(urlYuan)));
    }
    ...
    public static String compressionVideo(String urlYuan, String targetUrl) throws EncoderException {
        ...
        int maxWidth = 1280;
        if (StringUtils.isBlank(targetUrl)) {
            targetUrl = urlYuan.substring(0, urlYuan.lastIndexOf(".")) + NEW_VIDEO_ZIP_NAME_PRE_STR + maxWidth + urlYuan.substring(urlYuan.lastIndexOf("."));
        }
        File sourceFile = new File(urlYuan);
        File target = new File(targetUrl);
        MultimediaObject multimediaObject = new MultimediaObject(sourceFile);
        ...
        logger.info("开始压缩视频了--> 视频每秒平均 {} MB ", bd);
     ...
     */
    public static Map<Integer, String> generateVideoScreenImage(String urlYuan, String targetPath, List<Integer> secondsList) throws EncoderException {
        ...
        for (Integer seconds : secondsList) {
            ...
            if (checkIsGenScreenImage(targetUrl)) {
                urlMap.put(seconds, targetUrl);
            }
        }
        return urlMap;
    }
     ...
     * @throws EncoderException
     */
    public static String generateVideoScreenImage(String urlYuan) throws EncoderException {
        Map<Integer, String> list = generateVideoScreenImage(urlYuan, "", new ArrayList<>());
        if (list.isEmpty()) {
            return "";
        }
        return list.get(1);
     ...
     */
    public static boolean checkIsVideo(String urlYuan) {
     ...
     * @param url 视频绝对路径
     */
    public static boolean checkIsGenScreenImage(String url) {
